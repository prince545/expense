...
const AuthLayout = ({ children }) => {
  return (
    <div className="flex min-h-screen bg-white">
      ...
      <div className="w-full md:w-[60vw] px-6 md:px-16 py-12 flex flex-col">
      ...
      {/* Right Panel - Abstract Design with Image */}
      <div className="hidden md:block w-[40vw] h-screen bg-gradient-to-b from-violet-50 to-purple-50 relative overflow-hidden">
        {/* Large curved shapes */}
